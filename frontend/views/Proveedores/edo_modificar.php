...
<div class="<?php echo $obj_edo->container; ?>">
	<div class="row pb-3 mb-3 bg-white">
		<div class="col-12 text-left">
			<button class="<?php echo $obj_edo->btn_atras; ?>" onClick="window.location.href='edo_menu.php'"><i
				...
				<div class="card-body">
					<form action="../../backend/controller/proveedor.php" method="POST">
						<div class="row p-3">
							<div class="col-12">
								<div class="form-group">
									...
									<input type="text" name="nom_edo" id="nom_edo" placeholder="Nombre:" minlength="2" maxlength="50"
										require="" value="<?php echo $proveedor['nom_edo']; ?>"
							...
							<div class="col-12 col-md-12">
								<div class="form-group">
									...
									<input type="text" name="des_edo" id="des_edo" placeholder="Descripción:" minlength="3"
										maxlength="100" require="" value="<?php echo $proveedor['des_edo']; ?>"
										class="<?php echo $obj_edo->input_text; ?>">
								</div>
							</div>
							<div class="col-12 col-md-12">
								<div class="form-group">
									<label for="dir_edo" class="<?php echo $obj_edo->for; ?>">Dirección:</label>
									<input type="text" name="dir_edo" id="dir_edo" placeholder="Dirección:" minlength="3" maxlength="100"
										require="" value="<?php echo $proveedor['dir_edo']; ?>" class="<?php echo $obj_edo->input_text; ?>">
								</div>
							</div>
							<div class="col-12 col-md-6">
								<div class="form-group">
									<label for="tel_edo" class="<?php echo $obj_edo->for; ?>">Telefono:</label>
									<input type="text" name="tel_edo" id="tel_edo" placeholder="Telefono:" pattern="[0-9]+" minlength="11"
										maxlength="11" require="" value="<?php echo $proveedor['tel_edo']; ?>"
										class="<?php echo $obj_edo->input_normal; ?>">
								</div>
							</div>
							<div class="col-12 col-md-6">
								<div class="form-group">
									...
									<input type="email" name="cor_edo" id="cor_edo" placeholder="Correo:" minlength="1" maxlength="100"
										require="" value="<?php echo $proveedor['cor_edo']; ?>"
										class="<?php echo $obj_edo->input_normal; ?>">
								</div>
							</div>
							...
							<div class="col-12 col-md-4">
								<div class="form-group">
									...
									<input type="text" name="rif_edo" id="rif_edo" placeholder="RIF:" minlength="9" maxlength="9"
										require="" value="<?php echo $proveedor['rif_edo']; ?>"
										class="<?php echo $obj_edo->input_normal; ?>">
								</div>
							</div>
							<div class="col-12 col-md-4">
						...
						<div class="row p-3 text-center">
							<div class="col-6">
								<div class="form-group">
									<button type="reset" name="run" id="run" value="limpiar" require=""
										class="<?php echo $obj_edo->btn_limpiar; ?>">Limpiar</button>
								</div>
							</div>
							<div class="col-6">
								<div class="form-group">
									<button type="submit" name="run" id="run" value="update" require=""
										class="<?php echo $obj_edo->btn_enviar; ?>">Modificar</button>
								</div>
							</div>
						</div>
					</form>
