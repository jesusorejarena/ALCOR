							...
							<div class="col-12">
								<div class="form-group">
									...
									<input type="text" name="nom_emp" id="nom_emp" placeholder="Nombre:" minlength="3" maxlength="50"
										required="" class="<?php echo $obj_emp->input_normal; ?>">
								</div>
							</div>
						</div>
						<div class="row p-3">
						...
						<div class="row p-3">
							<div class="col-12">
								<div class="form-group">
									...
									<input type="email" name="cor_emp" id="cor_emp" placeholder="Correo:" minlength="3" maxlength="100"
										required="" class="<?php echo $obj_emp->input_normal; ?>">
								</div>
							</div>
						</div>
						<div class="row p-3">
							<div class="col-6">
								<div class="form-group">
									...
									<input type="text" name="hou_emp" id="hou_emp" placeholder="Horario Uno:" minlength="3" maxlength="19"
										required="" class="<?php echo $obj_emp->input_normal; ?>">
							...
							<div class="col-6">
								<div class="form-group">
									...
									<input type="text" name="hod_emp" id="hod_emp" placeholder="Horario Dos:" minlength="3" maxlength="19"
							...
							<div class="col-6">
								<div class="form-group">
									<button type="submit" name="run" id="run" value="create"
										class="<?php echo $obj_emp->btn_enviar; ?>">Registrar</button>
								</div>
							</div>
						</div>
					</form>
