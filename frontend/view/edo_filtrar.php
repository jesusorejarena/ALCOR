						...
						<div class="row p-3">
							<div class="col-12 col-md-2">
								<div class="form-group">
									...
									<input type="text" name="cod_edo" id="cod_edo" placeholder="Código:" pattern="[0-9]+"
							...
							<div class="col-12 col-md-10">
								<div class="form-group">
									...
									<input type="text" name="nom_edo" id="nom_edo" placeholder="Nombre:"
										class="<?php echo $obj_edo->input_normal; ?>">
								</div>
							</div>
							<div class="col-12">
								<div class="form-group">
									...
									<textarea name="des_edo" id="des_edo" placeholder="Descripción:"
							...
							<div class="col-12">
								<div class="form-group">
									...
									<input type="text" name="dir_edo" id="dir_edo" placeholder="Dirección:"
										class="<?php echo $obj_edo->input_normal; ?>">
								</div>
							</div>
							<div class="col-12 col-md-6">
								<div class="form-group">
									...
									<input type="text" name="tel_edo" id="tel_edo" placeholder="Teléfono:" pattern="[0-9]+"
										class="<?php echo $obj_edo->input_normal; ?>">
								</div>
							</div>
							<div class="col-12 col-md-6">
								<div class="form-group">
									...
									<input type="text" name="cor_edo" id="cor_edo" placeholder="Correo:"
										class="<?php echo $obj_edo->input_normal; ?>">
								</div>
							</div>
							<div class="col-12 col-md-6">
							...
							<div class="col-12 col-md-6">
								<div class="form-group">
									...
									<input type="text" name="rif_edo" id="rif_edo" placeholder="RIF:"
										class="<?php echo $obj_edo->input_normal; ?>">
								</div>
							</div>
							<div class="col-12 col-md-6">
