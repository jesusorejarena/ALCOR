							...
							while (($empleado = $obj_ado->extractData()) > 0) {
								echo "<form action='../../backend/controller/empleado.php' method='POST'>
												<tr>
													...
													<td><button type='submit' class='$obj_ado->btn_restaurar' name='run' value='restore'><i class='icon ion-md-refresh'></i></button></td>
													<td><button type='submit' class='$obj_ado->btn_eliminar' name='run' value='delete'><i class='icon ion-md-trash'></i></button></td>
												</tr>
											</form>
										";
							}
		...
		<!--<div class="card-body">
				<form action="../../backend/controller/empleado.php" method="POST">
					...
					<div class="form-group text-center">
						<button type="submit" name="run" id="run" value="create" class="<?php echo $obj_ado->btn_enviar; ?>">Registrar</button>
					</div>
				</form>
			</div>-->
	</div>
