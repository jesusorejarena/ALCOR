...
headerr("Recuperar contraseña");

?>

<!-- Formulario -->
<div class="container p-3 p-xl-2">
	<a class="btn btn-success btn-lg" href="usu_login.php"><i class="fas fa-arrow-circle-left"></i></a>
	<div class="row justify-content-center">
		<div class="col-12 col-xl-6 p-2">
			<div class="card rounded">
				<h2 class="card-title text-center pt-4">Recuperar contraseña</h2>
