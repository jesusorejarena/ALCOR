					...
					<div class="row p-1 m-1">
						<div class="col-12 p-1 m-1 text-center">
							<button class="<?php echo $obj_edo->btn_enviarg; ?>"
								onClick="window.location.href='edo_registrar.php'">Registrar</button>
						</div>
						<div class="col-12 p-1 m-1 text-center">
							<button class="<?php echo $obj_edo->btn_enviarg; ?>"
								onClick="window.location.href='edo_listartodo.php'">Lista</button>
						</div>
						<div class="col-12 p-1 m-1 text-center">
							<button class="<?php echo $obj_edo->btn_enviarg; ?>"
								onClick="window.location.href='edo_filtrar.php'">Filtrar</button>
						</div>
						<div class="col-12 p-1 m-1 text-center">
							<button class="<?php echo $obj_edo->btn_enviarg; ?>"
								onClick="window.location.href='edo_listarpapelera.php'">Papelera</button>
						</div>
					</div>
				</div>
			</div>
