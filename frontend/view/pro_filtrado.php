...
<div class="<?php echo $obj_pro->container; ?>">
	<div class="row pb-3 mb-3 bg-white">
		<div class="col-12 text-left">
			<button class="<?php echo $obj_pro->btn_atras; ?>" onClick="window.location.href='pro_filtrar.php'"><i
							...
							while (($producto = $obj_pro->extractData()) > 0) {
								echo "<form action='../../backend/controller/producto.php' method='POST'>
												<tr>
													...
													<td><button type='submit' class='$obj_pro->btn_eliminar' name='run' value='firstDelete'><i class='icon ion-md-trash'></i></button></td>
												</tr>
											</form>
										";
							}
