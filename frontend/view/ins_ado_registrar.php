	...
	<div class="row">
		...
		<div class="col-12 col-md-8">
			<div class="<?php echo $obj_ado->card; ?>">
				...
				<hr>
				<div class="card-body">
					<form action="../../backend/controller/instalacion.php" method="POST">
						<div class="row p-3">
							...
							<div class="col-12 col-md-6">
								<div class="form-group">
									...
									<input type="date" name="nac_ado" id="nac_ado" placeholder="Fecha de Nacimiento:" required=""
										class="<?php echo $obj_ado->input_normal; ?>">
								</div>
							</div>
							...
							<div class="col-12 col-md-4">
								<div class="form-group">
									...
									<input type="text" name="ced_ado" id="ced_ado" placeholder="Cédula:" pattern="[0-9]+" minlength="1"
										maxlength="8" required="" class="<?php echo $obj_ado->input_normal; ?>">
								</div>
							</div>
							<div class="col-12 col-md-4">
								<div class="form-group">
									<label for="tel_ado" class="<?php echo $obj_ado->for; ?>">Teléfono:</label>
									<input type="text" name="tel_ado" id="tel_ado" placeholder="Teléfono:" pattern="[0-9]+" minlength="11"
										maxlength="11" required="" class="<?php echo $obj_ado->input_normal; ?>">
								</div>
							</div>
							<div class="col-12">
								<div class="form-group">
						...
						<div class="row p-3 text-center">
							...
							<div class="col-6">
								<div class="form-group">
									<button type="submit" name="run" id="run" value="instalacion"
										class="<?php echo $obj_ado->btn_enviar; ?>">Siguiente</button>
								</div>
							</div>
						</div>
					</form>
