...
<div class="<?php echo $obj_mod->container; ?>">
	<div class="row pb-3 mb-3 bg-white">
		<div class="col-12 text-left">
			<button class="<?php echo $obj_mod->btn_atras; ?>" onClick="window.location.href='menu_config.php'"><i
						...
						<div class="row p-3">
							<div class="col-12 col-md-6">
								<div class="form-group">
									...
									<input type="text" name="cod_mod" id="cod_mod" placeholder="Código:" pattern="[0-9]+"
										class="<?php echo $obj_mod->input_normal; ?>">
								</div>
							</div>
							<div class="col-12 col-md-6">
								<div class="form-group">
									<label for="nom_mod" class="<?php echo $obj_mod->for; ?>">Nombre:</label>
									<input type="text" name="nom_mod" id="nom_mod" placeholder="Nombre:"
										class="<?php echo $obj_mod->input_normal; ?>">
								</div>
							</div>
							<div class="col-12 col-md-6">
							...
							<div class="col-6">
								<div class="form-group">
									<button type="submit" name="run" id="run" value="filter"
										class="<?php echo $obj_mod->btn_enviar; ?>">Filtrar</button>
								</div>
							</div>
						</div>
					</form>
