							...
							<div class="row p-1 m-1">
								<div class="col-12 p-1 m-1 text-center">
									<button class="<?php echo $obj_ado->btn_enviarg; ?>"
										onClick="window.location.href='ado_datospersonales.php'">Datos Personales</button>
									<button class="<?php echo $obj_ado->btn_enviarg; ?>"
										onClick="window.location.href='ado_cambiarcontrasena.php'">Cambiar Contraseña</button>
								</div>
							</div>
						</div>
					</div>
