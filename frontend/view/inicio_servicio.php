			...
			<div class="row mt-3 pt-3">
				<div class="col-6 p-5">
					<div class="text-dark animated wow slideInLeft fast">
						...
						<p class="text-justify p-3 m-3">Contamos con una extensa red de distribución a nivel nacional,
							proporcionándoles el apoyo necesario para que su comercio sea competitivo en variedad y calidad de
							productos de limpieza biodegradables.</p>
					</div>
				</div>
				<div class="col-6 p-5">
			...
			<div class="row mt-3 pt-3">
				...
				<div class="col-6 p-5">
					<div class="text-dark animated wow slideInRight fast">
						...
						<p class="text-justify p-3 m-3">Actualmente poseemos talento humano; expertos en marketing, quienes se
							encargan de posicionar la imagen institucional y reforzar los procesos de venta de manera óptima mediante
							el asesoramiento, la proactividad y la eficacia.</p>
					</div>
				</div>
			</div>
			...
			<div class="row mt-3 pt-3">
				<div class="col-6 p-5">
					<div class="text-dark animated wow slideInLeft fast">
						...
						<p class="text-justify p-3 m-3">Para nosotros es fundamental que nuestra fuerza de venta se encuentre en
							continua mejora, es por ello que nos volcamos a la enseñanza ofreciendo a nuestros exclusivos clientes
							cursos de formación, charlas, demostraciones, videos, instructivos, entre otros, adaptados a las
							necesidades concretas de cada zona y cliente.</p>
					</div>
				</div>
				<div class="col-6 p-5">
					<div class="text-dark text-center animated wow slideInLeft fast">
			...
			<div class="row mt-3 pt-3">
				...
				<div class="col-6 p-5">
					<div class="text-dark animated wow slideInRight fast">
						...
						<p class="text-justify p-3 m-3">Nuestra organización pone a disposición el servicio “Phone Help”, un equipo
							humano dedicado exclusivamente al asesoramiento técnico, despeje de dudas o urgencias de rápida resolución
							a través de la línea telefónica:<br>
							<?php
							echo " 
											$empresa[tel_emp]<br>
