...
<div class="<?php echo $obj_for->container; ?>">
	<div class="row pb-3 mb-3 bg-white">
		<div class="col-12 text-left">
			<button class="<?php echo $obj_for->btn_atras; ?>" onClick="window.location.href='for_filterBackup.php'"><i
						...
						<div class="row p-3">
							<div class="col-12">
								<div class="form-group">
									...
									<input type="text" name="cod_for" id="cod_for" placeholder="Código:" pattern="[0-9]+"
										class="<?php echo $obj_for->input_normal; ?>">
								</div>
							</div>
							<div class="col-12 col-md-6">
								<div class="form-group">
									<label for="nom_for" class="<?php echo $obj_for->for; ?>">Nombre:</label>
									<input type="text" name="nom_for" id="nom_for" placeholder="Nombre:"
										class="<?php echo $obj_for->input_normal; ?>">
								</div>
							</div>
							<div class="col-12 col-md-6">
								<div class="form-group">
									...
									<input type="text" name="ape_for" id="ape_for" placeholder="Apellido:"
										class="<?php echo $obj_for->input_normal; ?>">
								</div>
							</div>
							<div class="col-12 col-md-6">
								<div class="form-group">
									...
									<input type="text" name="tel_for" id="tel_for" placeholder="Teléfono:" pattern="[0-9]+"
										class="<?php echo $obj_for->input_normal; ?>">
								</div>
							</div>
							<div class="col-12 col-md-6">
								<div class="form-group">
									...
									<input type="text" name="cor_for" id="cor_for" placeholder="Correo:"
										class="<?php echo $obj_for->input_normal; ?>">
								</div>
							</div>
						</div>
							...
							<div class="col-6">
								<div class="form-group">
									<button type="reset" name="run" id="run" value="limpiar"
										class="<?php echo $obj_for->btn_limpiar; ?>">Limpiar</button>
								</div>
							</div>
							<div class="col-6">
								<div class="form-group">
									<button type="submit" name="run" id="run" value="filter"
										class="<?php echo $obj_for->btn_enviar; ?>">Filtrar</button>
								</div>
							</div>
						</div>
					</form>
