...
<div class="<?php echo $obj_ado->container; ?>">
	<div class="row pb-3 mb-3 bg-white">
		<div class="col-12 text-left">
			<button class="<?php echo $obj_ado->btn_atras; ?>" onClick="window.location.href='ado_filtrar.php'"><i
							...
							while (($empleado = $obj_ado->extractData()) > 0) {
								...
								if ($empleado['cod_ado'] == 1 || $empleado['cod_car'] == 1) {
									...
									echo "
																...
																<td><button type='submit' class='$obj_ado->btn_eliminar' name='run' value='firstDelete'><i class='icon ion-md-trash'></i></button></td>
														";
								}
								echo "
												</tr>
