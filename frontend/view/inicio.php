	...
	<div class="row pt-3 mt-3">
		...
		<div class="col-12 col-md-10">
			...
			<div class="row mt-3 pt-3 mx-3 px-3 text-justify">
				<div class="col-12">
					<div class="text-dark text-center animated wow zoomIn fast">
						<h3 class="h3">Comercializadora Alcor C.A, Distribuye productos genericos de limpieza de alta calidad a las empresas lider dedicadas al sector terciario de la economia a nivel local, regional y nacional.</h3>
					</div>
				</div>
			</div>
