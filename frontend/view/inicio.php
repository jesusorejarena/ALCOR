				...
				<div class="row">
					...
					<div class="col-12 col-xl-6 my-3 my-xl-5">
						...
						<p class="text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus ea est dolores
							...
							obcaecati. Qui numquam omnis laborum vel.</p>
					</div>
				</div>
			</div>
					...
					<div class="col-12 col-xl-6 text-center my-3">
						<div class="row">
							<div class="col-12">
								...
								<p class="mx-2">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Debitis, ad deserunt adipisci
									dignissimos ducimus maxime.</p>
							</div>
								...
								<div class="col-xl-8">
									<div class="card-body">
										<p class="card-text">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolores qui eveniet
											...
											minima cum eum temporibus labore quos hic praesentium.</p>
										<p class="card-text text-right"><small class="text-muted">Anio 1998</small></p>
									</div>
								</div>
							</div>
						</div>
