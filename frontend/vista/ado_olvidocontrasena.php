	...
	<div class="<?php echo $obj_ado->container; ?>">
		<div class="row pb-3 mb-3 bg-white">
			<div class="col-12 text-left">
				<button class="<?php echo $obj_ado->btn_atras; ?>" onClick="window.location.href='usu_sesion.php'"><i class="icon ion-md-arrow-round-back"></i></button>
			</div>
		</div>
		<div class="row">
					...
					<div class="card-body">
						<form action="../../backend/controlador/empleado.php" method="POST">
							<div class="row p-3">
								...
								<div class="col-12">
									<div class="form-group">
										...
										<input type="text" name="ced_ado" id="ced_ado" placeholder="Cédula:" minlength="8" maxlength="8" required="" class="<?php echo $obj_ado->input_normal; ?>">
									</div>
								</div>
								<div class="col-12">
									<div class="form-group">
								...
								<div class="col-12">
									<div class="form-group">
										...
										<input type="date" name="nac_ado" id="nac_ado" placeholder="Fecha de Nacimiento:" minlength="3" maxlength="100" required="" class="<?php echo $obj_ado->input_normal; ?>">
									</div>
								</div>
								<div class="col-12">
									<div class="form-group">
							...
							<div class="row p-3 text-center">
								...
								<div class="col-6">
									<div class="form-group">
										<button type="submit" name="ejecutar" id="ejecutar" value="comprobar_datos" class="<?php echo $obj_ado->btn_enviar; ?>">Cambiar</button>
									</div>
								</div>
							</div>
						</form>
