					...
					<div class="row mt-3 pt-3">
						<div class="col-4">
							<div class="text-dark text-center animated wow slideInLeft fast">
								...
								<p>Detergente líquido para ropa delicada. Especial para ropa íntima, ropa para infantes y texturas suaves como la seda.</p>
							</div>
						</div>
						<div class="col-4"></div>
						<div class="col-4">
							<div class="text-dark text-center animated wow slideInRight fast">
								...
								<p>Limpiadores, desengrasantes y desinfectantes para usos diversos. Desde cocinas, baños, todo tipo de suelos y superficies.</p>
							</div>
						</div>
					</div>
