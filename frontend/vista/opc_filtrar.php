...
?>
	...
	<div class="<?php echo $obj_opc->container; ?>">
		...
		<div class="<?php echo $obj_opc->card; ?>" style="width: 40rem">
			...
			<hr>
			<div class="card-body">
				<form action="opc_filtrado.php" method="POST">
					<div class="row p-3">
						<div class="col-6">
							<div class="form-group">
								<label for="nom_opc" class="<?php echo $obj_opc->for; ?>">Nombre:</label>
								<input type="text" name="nom_opc" id="nom_opc" placeholder="Nombre:" class="<?php echo $obj_opc->input_normal; ?>">
							</div>
						</div>
						<div class="col-6">
							<div class="form-group">
								<label for="des_opc" class="<?php echo $obj_opc->for; ?>">Descripción:</label>
								<input type="text" name="des_opc" id="des_opc" placeholder="Descripción:" class="<?php echo $obj_opc->input_normal; ?>">
							</div>
						</div>
					</div>
					<div class="row p-3">
						<div class="col-12">
							<div class="form-group">
								...
								<input type="text" name="url_opc" id="url_opc" placeholder="URL:" class="<?php echo $obj_opc->input_normal; ?>">
							</div>
						</div>
					</div>
					<div class="row p-3 text-center">
						...
						<div class="col-6">
							<div class="form-group">
								<button type="submit" name="ejecutar" id="ejecutar" value="filtrar" class="<?php echo $obj_opc->btn_enviar; ?>">Filtrar</button>
							</div>
						</div>
					</div>
				</form>
