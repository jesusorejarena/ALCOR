	...
	<div class="<?php echo $obj_for->container; ?>">
		<div class="row pb-3 mb-3 bg-white">
			<div class="col-12 text-left">
				<button class="<?php echo $obj_for->btn_atras; ?>" onClick="window.location.href=''">Atras</button>
			</div>
		</div>
			...
			<div class="card-body">
				<form action="ado_filtrado.php" method="POST">
					...
					<div class="row p-3 text-center">
						...
						<div class="col-6">
							<div class="form-group">
								<button type="submit" name="ejecutar" id="ejecutar" value="filtrar" class="<?php echo $obj_for->btn_atras; ?> btn-lg">Filtrar</button>
							</div>
						</div>
					</div>
				</form>
