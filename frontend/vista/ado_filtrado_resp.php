<?php	
	...
	$obj_ado->estandar();
	$obj_ado->puntero=$obj_ado->filtrar_resp();
	
	encabezado("Empleados Filtrados 'Historial'");
	...
	<div class="<?php echo $obj_ado->container; ?>">
		<div class="row pb-3 mb-3 bg-white">
			<div class="col-12 text-left">
				<button class="<?php echo $obj_ado->btn_atras; ?>" onClick="window.location.href='ado_filtrar_resp.php'"><i class="icon ion-md-arrow-round-back"></i></button>
			</div>
		</div>
		<div class="<?php echo $obj_ado->card; ?>">
			<h2 class="<?php echo $obj_ado->titulocard; ?>">Empleados Filtrados 'Historial'</h2>
			<hr>
