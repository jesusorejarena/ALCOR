	...
	<div class="<?php echo $obj_car->container; ?>">
		<div class="row pb-3 mb-3 bg-white">
			<div class="col-12 text-left">
				<button class="<?php echo $obj_car->btn_atras; ?>" onClick="window.location.href='ado_menu.php'"><i class="icon ion-md-arrow-round-back"></i></button>
			</div>
		</div>
		<div class="row">
							...
							<div class="row p-3">
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<select name="cod_car" id="cod_car" required="" class="<?php echo $obj_car->input_normal; ?>">
											<option value="">Seleccione...</option>
											<?php while (($cargo=$obj_car->extraer_dato())>1)
												{
								...
								<div class="col-12">
									<div class="form-group">
										...
										<input type="password" name="cla_ado" id="cla_ado" placeholder="Clave:" minlength="8" maxlength="20" required="" class="<?php echo $obj_car->input_normal; ?>">
									</div>
								</div>
								<div class="col-12">
									<div class="form-group">
