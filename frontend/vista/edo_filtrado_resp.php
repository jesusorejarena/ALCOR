<?php	
	...
	$obj_edo->puntero=$obj_edo->filtrar_resp();

	encabezado("Proveedores Filtrados 'Historial'");
	...
	<div class="<?php echo $obj_edo->container; ?>">
		<div class="row pb-3 mb-3 bg-white">
			<div class="col-12 text-left">
				<button class="<?php echo $obj_edo->btn_atras; ?>" onClick="window.location.href='edo_filtrar_resp.php'"><i class="icon ion-md-arrow-round-back"></i></button>
			</div>
		</div>
		<div class="<?php echo $obj_edo->card; ?>">
			<h2 class="<?php echo $obj_edo->titulocard; ?>">Proveedores Filtrados 'Historial'</h2>
			<hr>
