	...
	<div class="<?php echo $obj_emp->container; ?>">
		<div class="row pb-3 mb-3 bg-white">
			<div class="col-12 text-left">
				<button class="<?php echo $obj_emp->btn_atras; ?>" onClick="window.location.href='emp_menu.php'"><i class="icon ion-md-arrow-round-back"></i></button>
			</div>
		</div>
		<div class="row">
							...
							<div class="row p-3">
								<div class="col-12">
									<div class="form-group">
										...
										<input type="text" name="nom_emp" id="nom_emp" placeholder="Nombre:" pattern="[A-Za-z]" minlength="3" maxlength="50" required="" value="<?php echo $empresa['nom_emp']; ?>" class="<?php echo $obj_emp->input_normal; ?>">
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="tel_emp" class="<?php echo $obj_emp->for; ?>">Teléfono:</label>
										<input type="text" name="tel_emp" id="tel_emp" placeholder="Teléfono:" pattern="[0-9]" minlength="11" maxlength="13" required="" value="<?php echo $empresa['tel_emp']; ?>" class="<?php echo $obj_emp->input_normal; ?>">
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text" name="rif_emp" id="rif_emp" placeholder="RIF:" pattern="[A-Za-z0-9]" minlength="12" maxlength="12" required="" value="<?php echo $empresa['rif_emp']; ?>" class="<?php echo $obj_emp->input_normal; ?>">
								...
								<div class="col-12">
									<div class="form-group">
										...
										<input type="text" name="dir_emp" id="dir_emp" placeholder="Dirección:" pattern="[A-Za-z0-9]" minlength="3" maxlength="100" required="" value="<?php echo $empresa['dir_emp']; ?>" class="<?php echo $obj_emp->input_normal; ?>">
									</div>
								</div>
								<div class="col-12">
									<div class="form-group">
										<label for="cor_emp" class="<?php echo $obj_emp->for; ?>">Correo:</label>
										<input type="text" name="cor_emp" id="cor_emp" placeholder="Correo:" pattern="[A-Za-z0-9]" minlength="3" maxlength="100" required="" value="<?php echo $empresa['cor_emp']; ?>" class="<?php echo $obj_emp->input_normal; ?>">
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="hou_emp" class="<?php echo $obj_emp->for; ?>">Horario Uno:</label>
										<input type="text" name="hou_emp" id="hou_emp" placeholder="Horario Uno:" pattern="[A-Za-z0-9]" minlength="19" maxlength="19" required="" value="<?php echo $empresa['hou_emp']; ?>" class="<?php echo $obj_emp->input_normal; ?>">
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text" name="hod_emp" id="hod_emp" placeholder="Horario Dos:" pattern="[A-Za-z0-9]" minlength="19" maxlength="19" value="<?php echo $empresa['hod_emp']; ?>" class="<?php echo $obj_emp->input_normal; ?>">
