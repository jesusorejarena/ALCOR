					...
					<div class="row">
						<div class="col-6 px-5">
							<div class="text-dark text-center animated wow slideInLeft fast">
								...
								<p class="text-justify">Nuestro compromiso principal está enfocado en el medio ambiente y la gente, por ello nos especializamos en comercializar y proveer productos de limpieza biodegradables en todo el territorio nacional, contando con una red de distribución sólida que se ve fortificada por servicios eficientes y proactivos.</p>
							</div>
						</div>
						<div class="col-6 px-5">
					...
					<div class="row mt-3 pt-3">
						...
						<div class="col-6 p-5">
							<div class="text-dark animated wow slideInRight fast">
								...
								<p class="text-justify">Nuestra política de calidad va en concordancia con las legislaciones y convenios nacionales e internacionales en cuanto a la protección del entorno ambiental y la satisfacción de las necesidades de nuestros clientes internos y externos. Para ello nos comprometemos a establecer:</p>
								<ul class="text-justify">
